   ...
   <form>
       <div class="container">
           ...
           <div class="row">
               ...
               <div class="col-md-8"><input class="form-control" type="text" placeholder="Name"></div>
           </div>
           <div class="row">
               <div class="col-md-4"><label>Beschreibung der App: </label></div>
               <div class="col-md-8"><textarea class="md-textarea form-control" placeholder="Beschreibung" rows="4" cols="50"></textarea></div>
           </div>
           <div class="row">
               <div class="col-md-4"><label>Download Link:</label></div>
               <div class="col-md-8"><input class="form-control" type="text" placeholder="https://"></div>
           </div>
               <br>
               <div class="row">
           ...
           <div class="row">
               ...
               <div class="col-md-2"><div class="custom-control custom-checkbox"></div>
                   <input type="checkbox" class="custom-control-input" id="asthma" name="asthma">
                   <label class="custom-control-label" for="asthma">Diabetes</label></div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="reason_q1" rows="5" cols="150"></textarea>
               </div>
               </div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="reason_q2" rows="5" cols="150"></textarea>
               </div>
           </div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="risk_q1" rows="5" cols="150"></textarea>
               </div>
           </div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="risk_q2" rows="5" cols="150"></textarea>
               </div>
           </div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="ethnic_q1" rows="5" cols="150"></textarea>
               </div>
           </div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="ethnic_q2" rows="5" cols="150"></textarea>
               </div>
           </div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="ethnic_q3" rows="5" cols="150"></textarea>
               </div>
           </div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="law_q1" rows="5" cols="150"></textarea>
               </div>
           </div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="content_q1" rows="5" cols="150"></textarea>
               </div>
           </div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="content_q2" rows="5" cols="150"></textarea>
               </div>
           </div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="technic_q1" rows="5" cols="150"></textarea>
               </div>
           </div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="technic_q2" rows="5" cols="150"></textarea>
               </div>
           </div>
           ...
           <div class="row">
               <div class="form-group green-border-focus">
                   ...
                   <textarea class="form-control" id="use_q1" rows="5" cols="150"></textarea>
               </div>
           </div>

           <div class="row">
               <div class="form-group green-border-focus">
                   <label for="use_q1">Wurde die App nach «usability guidelines» entwickelt? *** muss noch angepasst werden***</label>
                   <textarea class="form-control" id="use_q1" rows="5" cols="150"></textarea>
               </div>
           </div>
           ...
           <div class="row">
               <div class="input-group">
                   ...
                   <div class="custom-file">
                       <input type="file" class="custom-file-input" id="inputAppPictureField" aria-describedby="inputAppPicture">
           ...
           <div class="row">
               <button type="submit" class="btn btn-outline-primary waves-effect"><i aria-hidden="true"></i>Absenden</button>
           </div>
